            ...
            <ul>
                ...
                <li class="has-sub">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ url('/laws') }}">กฎหมาย ระเบียบ ข้อบังคับ</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ url('/posts/292') }}">แผนดำเนินงานและการใช้จ่ายงบประมาณประจำปี</a>
                        </li>
                        <li>
                            <a href="{{ url('/posts/238') }}">รายงานผลการดำเนินงานประจำปี</a>
                        </li>
                    </ul>
                </li>
                <li class="has-sub">
