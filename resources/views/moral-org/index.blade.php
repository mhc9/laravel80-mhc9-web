                ...
                <a href="{{ url('/') }}">
                    <div class="content-bullet">
                        <div class="w-full">
                            ...
                            <ul class="m-0">
                                <li class="m-0"><a href="{{ url('/post/515') }}">กิจกรรมที่ 1 โครงการเสริมสร้างความเข้มแข็งของกลไกการป้องกันทุจริตและระบบบริหารจัดการตามหลักธรรมาภิบาล</a></li>
                                <li class="m-0"><a href="{{ url('/post/516') }}">กิจกรรมที่ 2 ครอบครัวอบอุ่นสรรสร้างคุณธรรม</a></li>
