    ...
    <div class="content-wrapper">
        <div class="min-h-screen p-4">
            <div class="text-center">
                <h2 class="text-2xl font-bold mt-2 mb-8">การดำเนินการเป็นองค์กรคุณธรรมต้นแบบ ประจำปีงบประมาณ พ.ศ. 2568 ของศูนย์สุขภาพจิตที่ 9 กรมสุขภาพจิต</h2>
            </div>
            ...
            <div class="mt-4">
                ...
                <a href="{{ url('/') }}">
                    <div class="content-bullet">
                        <h4 class="text-[16px]">3.2 แผนปฏิบัติการส่งเสริมคุณธรรมของหน่วยงาน</h4>
                        <span><i class="fas fa-angle-down"></i></span>
                    </div>
                </a>
            </div>
            ...
            <div class="mt-4">
                ...
                <a href="{{ url('/') }}">
                    <div class="content-bullet">
                        <h4 class="text-[16px]">6.2 การประชาสัมพันธ์ผ่านช่องทางการสื่อสาร</h4>
                        <span><i class="fas fa-angle-down"></i></span>
                    </div>
                </a>
            </div>
