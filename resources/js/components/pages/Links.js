...
const Links = () => {
    return (
        <section className="links container">
            <h1 className="title">ลิงค์ที่เกี่ยวข้อง</h1>
            ...
            <div className="links-wrapper">
                <ul>
                    ...
                    <li>
                        <a href="#" target="_blank">กลุ่มศูนย์สุขภาพจิต กรมสุขภาพจิต</a>
                        <ul>
                            ...
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 3 นครสวรรค์</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 4 ปทุมธานี</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 5 สมุทรสงคราม</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 6 ชลบุรี</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 7 ขอนแก่น</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 8 อุดรธานี</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 9 นครราชสีมา</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 10 อุบลราชธานี</a></li>
                            <li><a href="#" target="_blank">ศูนย์สุขภาพจิต 11 สุราษฎร์ธานี</a></li>
                            <li><a href="https://mhc12.dmh.go.th/mhc12" target="_blank">ศูนย์สุขภาพจิต 12 สงขลา</a></li>
